CREATE TABLE Monasteries (
	Id INT CONSTRAINT PK_MON_ID PRIMARY KEY IDENTITY,
	[Name] NVARCHAR(100) NOT NULL UNIQUE,
	CountryCode CHAR(2) NOT NULL CONSTRAINT FK_COUNTRY_CODE FOREIGN KEY REFERENCES Countries(CountryCode)
)
...
SELECT mon.Name AS [Monastery], c.CountryName
