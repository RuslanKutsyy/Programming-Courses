...
namespace ProductShop
{
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine(ImportProducts(dbContext, File.ReadAllText(@"C:\\Users\rusla\\Documents\\GitHub\\SoftUniCourses\\C# Course\\C# DB\\Entity Framework Core\\JSON PROCESSING\\Product Shop\\ProductShop\\Datasets\\products.json")));
        }
